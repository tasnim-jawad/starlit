...
use App\Modules\Management\PurchaseOrderManagement\PurchaseOrderCollection\Controller\Controller;
use Illuminate\Support\Facades\Route;

Route::prefix('v1')->group(function () {
    Route::prefix('purchase-order-collections')->group(function () {
