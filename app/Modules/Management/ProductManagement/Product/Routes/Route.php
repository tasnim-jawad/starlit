...
use App\Modules\Management\ProductManagement\Product\Controller\Controller;
...
Route::prefix('v1')->group(function () {
    ...
    Route::get('get-all-product-by-warehouse-id', [Controller::class, 'GetAllProductByWarehouseId']);
});
