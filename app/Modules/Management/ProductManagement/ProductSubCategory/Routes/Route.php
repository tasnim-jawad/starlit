...
use App\Modules\Management\ProductManagement\ProductSubCategory\Controller\Controller;
...
Route::prefix('v1')->group(function () {
    ...
    Route::get('get-all-sub-category-by-category-id/{category_id}', [Controller::class, 'GetAllSubCategoryByCategoryId']);
});
