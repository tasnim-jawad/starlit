...
export default {
    ...
    methods: {
                ...
                this.form_fields.forEach((field, index) => {
                    Object.entries(this.item).forEach((value) => {
                        ...
                        if (
                            ...
                            $("#feedback").summernote("code", value[1]);
                        }
                    });
                });
            }
        ...
        setSummerEditor() {
            var markupStr = $("#feedback").summernote("code");
            var target = document.createElement("input");
            target.setAttribute("name", "feedback");
            target.value = markupStr;
            document.getElementById("feedback").appendChild(target);
        },
    },
