        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-area ltn__section-title-2--- text-center">
                    <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Property Listings</h6>
                    <h1 class="section-title">Wellness Communities Property</h1>
                </div>
            </div>
        </div>
        ...
        <div>
            <ul>
                <li class="special-link show_button">
                    <a href="{{ route('properties.wellness') }}">Show more</a>
                </li>
            </ul>
        </div>
    </div>
